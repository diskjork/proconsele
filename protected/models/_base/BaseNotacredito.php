...
abstract class BaseNotacredito extends GxActiveRecord {
	...
	public function attributeLabels() {
		return array(
			...
			'nrodefactura' => Yii::t('app', 'Nrodefactura'),
			'fecha' => Yii::t('app', 'Fecha'),
			'formadepago' => Yii::t('app', 'Formadepago'),
			...
			'impuestointerno' => Yii::t('app', 'Impuestointerno'),
			...
			'factura_idfactura' => Yii::t('app', 'Factura Idfactura'),
			'tipofactura' => Yii::t('app', 'Tipofactura'),
			'nronotacredito' => Yii::t('app', 'Nronotacredito'),
		);
	}
