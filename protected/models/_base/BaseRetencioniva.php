...
/**
 * This is the model base class for the table "retencioniva".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Retencioniva".
 *
 * Columns in table "retencioniva" available as properties of the model,
 * and there are no model relations.
 *
 * @property integer $idretencionIVA
 ...
 *
 */
abstract class BaseRetencioniva extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Retencioniva|Retencionivas', $n);
	}
	...
	public function rules() {
		return array(
			...
			array('idretencionIVA, nrocomprobante, cliente_idcliente, fecha, comp_relacionado, importe, tasa, detallecobranza_iddetallecobranza', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			'idretencionIVA' => Yii::t('app', 'Idretencion Iva'),
	...
	public function search() {
		...
		$criteria->compare('idretencionIVA', $this->idretencionIVA);
