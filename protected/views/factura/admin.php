...
for($i=0;$i<12;$i++){
	...
	$arregloTabsMeses[]=array('label'=>$meses[$i][1],'content'=>$this->renderPartial('_verfactura', array('model'=>$model,'mesTab'=>$meses[$i][0],'anioTab'=>$anioTab), true),'active'=>$$varTempMes);
}
