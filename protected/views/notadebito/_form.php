...
<?php  Yii::app()->clientScript->registerScriptFile(Yii::app()->request->baseUrl.'/js_plugin/notadebito.js', CClientScript::POS_HEAD);?>
...
<div class="well" id="encabezadonotadebito" style="margin-bottom: 10px; width:80%; padding-bottom: 0px;padding-top: 5px;">
	...
	<tr style="width:100%;">
		...
		<td style="width:50%; text-align: center;">
		<div id="nronotadebito" >
		<?php echo $form->textFieldControlGroup($model,'nronotadebito',array('span'=>2)); ?>
		</div>
		</td>
