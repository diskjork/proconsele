...
<div class="form">
	...
	<div class="container-fluid">
    	<div class="row-fluid">
	    	<div class="well">
  			<?php echo "<strong>Cuenta Bancaria: </strong>".$model->chequeraIdchequera->ctabancariaIdctabancaria."<br>";?>	
			...
			<?php echo "<strong>Fecha de Emisión: </strong>".$model->fechaingreso."<br>";?>
			...
			<?php echo $form->hiddenField($modelBanco,'ctabancaria_idctabancaria', array('value'=>$model->chequeraIdchequera->ctabancaria_idctabancaria)); ?>
			...
			<?php  echo $form->hiddenField($modelBanco,'cuenta_idcuenta', array('value'=>$model->chequeraIdchequera->cuenta_idcuenta)); ?>
		...
		<?php 
			if(!$model->isNewRecord){
				echo CHtml::link('Volver', Yii::app()->request->baseUrl.'/cheque/emitido',array ('class'=>'btn btn-primary'));
 ...
 $.ajax({
  ...
  success:	function(data){
     ...
     if(obj.check == "success"){
         window.location = "<?php echo Yii::app()->createUrl("cheque/emitido"); ?>"; 
     }
     
	if(obj.Movimientobanco_fecha == "Fecha no puede ser nulo."){
				$("#error-div-Banco").show();
				$("#error-div-Banco").append("<strong>Fecha de cobro</strong> no puede ser nulo.");
	}	
