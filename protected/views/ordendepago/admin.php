...
<h5 class="well well-small">ORDENES DE PAGO</h5>
<?php
//para la barra de los años 
	...
	for($i=0;$i<12;$i++){
		...
		$arregloTabsMeses[]=array('label'=>$meses[$i][1],'content'=>$this->renderPartial('gridordendepago', array('model'=>$model,'mesTab'=>$meses[$i][0],'anioTab'=>$anioTab), true),'active'=>$$varTempMes);
		}
