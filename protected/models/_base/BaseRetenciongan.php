...
/**
 * This is the model base class for the table "retenciongan".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Retenciongan".
 *
 * Columns in table "retenciongan" available as properties of the model,
 * and there are no model relations.
 *
 * @property integer $idretencionGAN
 ...
 *
 */
abstract class BaseRetenciongan extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Retenciongan|Retenciongans', $n);
	}
	...
	public function rules() {
		return array(
			...
			array('idretencionGAN, nrocomprobante, cliente_idcliente, fecha, comp_relacionado, importe, tasa, detallecobranza_iddetallecobranza', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels() {
		return array(
			'idretencionGAN' => Yii::t('app', 'Idretencion Gan'),
	...
	public function search() {
		...
		$criteria->compare('idretencionGAN', $this->idretencionGAN);
