...
<div class="wide form">
	...
	'method'=>'get',
                    ...
                    <?php echo $form->textFieldControlGroup($model,'idfactura',array('span'=>5)); ?>

                    <?php echo $form->textFieldControlGroup($model,'nrodefactura',array('span'=>5,'maxlength'=>45)); ?>

                    <?php echo $form->textFieldControlGroup($model,'tipofactura',array('span'=>5)); ?>

                    <?php echo $form->textFieldControlGroup($model,'nroremito',array('span'=>5)); ?>
                    ...
                    <?php echo $form->textFieldControlGroup($model,'presupuesto',array('span'=>5)); ?>

                    <?php echo $form->textFieldControlGroup($model,'nropresupuesto',array('span'=>5)); ?>
