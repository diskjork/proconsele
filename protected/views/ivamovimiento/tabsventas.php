...
<h5 class="well well-small">LIBRO IVA VENTAS</h5>
...
<?php 
	...
	for ($i=$anioInicio;$i<$anioSiguiente;$i++){	
		...
		$arregloTabs [] =array('label'=>$i, 'url'=>array('tabsventas','anioTab'=>$i),'active'=>$$varTemp);
	}
?>
...
for($i=0;$i<12;$i++){
	...
	$arregloTabsMeses[]=array('label'=>$meses[$i][1],'content'=>$this->renderPartial('adminventas', array('model'=>$model,'mesTab'=>$meses[$i][0],'anioTab'=>$anioTab), true),'active'=>$$varTempMes);
}
