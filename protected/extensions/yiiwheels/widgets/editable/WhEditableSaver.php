...
class WhEditableSaver extends CComponent
{
    ...
    {
        if (empty($modelClass)) {
            throw new CException(Yii::t('WhEditableSaver.editable', 'You should provide modelClass in constructor of EditableSaver.'));
        }
    ...
    public function update()
    {
        ...
        if (empty($this->attribute)) {
            throw new CException(Yii::t('WhEditableSaver.editable','Property "attribute" should be defined.'));
        }
        ...
        if (empty($this->primaryKey) && !$isFormModel) {
            throw new CException(Yii::t('WhEditableSaver.editable','Property "primaryKey" should be defined.'));
        }
        ...
        if (!$this->model) {
            throw new CException(Yii::t('WhEditableSaver.editable', 'Model {class} not found by primary key "{pk}"', array(
        ...
        if (!$this->model->isAttributeSafe($this->attribute)) {
            throw new CException(Yii::t('WhEditable', 'Model {class} rules do not allow to update attribute "{attr}"', array(
        ...
        if ($result) {
            ...
            $this->error(Yii::t('WhEditableSaver.editable', 'Error while saving record!'));
        }
    }
