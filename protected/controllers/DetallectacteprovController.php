...
class DetallectacteprovController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Detallectacteprov');
	...
	public function actionExcel(){
                ...
                $model=new Detallectacteprov('search');
               	...
               	$this->widget('application.components.widgets.EExcelView', array(
				    ...
				    'id'                   => 'some-grid',
				    'dataProvider'		   => $model->Search($model->fecha=$mes_tab."/".$anio_tab,$model->ctacteprov_idctacteprov=$idprov),
				    'grid_mode'            => 'export', // Same usage as EExcelView v0.33
				    //'template'             => "{summary}\n{items}\n{exportbuttons}\n{pager}",
				    'title'                => 'CC Proveedor ' . date('d-m-Y'),
				    'creator'              => 'YVN',
				    ...
				    'lastModifiedBy'       => 'YVN',
				    'sheetTitle'           => 'CC Proveedor ' . date('m-d-Y H-i'),
				    'keywords'             => '',
				    'category'             => '',
