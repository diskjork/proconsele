    ...
    <?php echo $form->errorSummary($model); ?>
			...
			<?php if(isset($model->desactivadas)){
			   ...
			   $this->widget('yiiwheels.widgets.select2.WhSelect2', array(
							    ...
							    'model'=>$model,
						   		'language'=>'es',
				    			'attribute' => 'nombre',
					    		'data' => GxHtml::listDataEx(Caja::model()->
						   				findAllAttributes(array('nombre'),true,array('condition'=>'estado=0','order'=>'nombre ASC')),'idcaja','nombre'),
					    		'pluginOptions' => array(
							    	'width' => '90%',
				...
				$var=1;
				echo "<h5> No hay ninguna caja deshabilitada</h5>";
			}
						?>
        ...
        <?php if(!isset($var)){
            ...
            'color'=>TbHtml::BUTTON_COLOR_PRIMARY,
		 	...
		 	echo " ".CHtml::link('Cancelar', Yii::app()->request->baseUrl.'/caja/admin',array ('class'=>'btn btn-primary'));
        } else {
        	echo CHtml::link('Volver', Yii::app()->request->baseUrl.'/caja/admin',array ('class'=>'btn btn-primary'));
        }
		 	?>
