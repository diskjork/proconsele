...
class CtacteclienteController extends Controller
{
	...
	{
		$model=new Ctactecliente;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if (isset($_POST['Ctactecliente'])) {
			$model->attributes=$_POST['Ctactecliente'];
			if ($model->save()) {
				$this->redirect(array('view','id'=>$model->idctactecliente));
			}
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Ctactecliente');
	 ...
	 * @return Ctactecliente the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Ctactecliente::model()->findByPk($id);
		if ($model===null) {
	 ...
	 * @param Ctactecliente $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='ctactecliente-form') {
	...
	public function actionExcel(){
                $model=new Ctactecliente('search');
               	...
               	$this->widget('application.components.widgets.EExcelView', array(
				    ...
				    'lastModifiedBy'       => 'YVN',
				    'sheetTitle'           => 'CC Clientes ' . date('m-d-Y H-i'),
				    'keywords'             => '',
				    'category'             => '',
